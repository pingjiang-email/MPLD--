...
import numpy as np
import configs_MPLD as configs
...
class MPLD(nn.Module):
    def __init__(self, config):
        '''
        MPLD Model
        '''
        super(MPLD, self).__init__()
...
CONFIGS = {
    'MPLD': configs.get_3DMPLD_config(),
    'MPLD-No-Conv-Skip': configs.get_3DMPLDNoConvSkip_config(),
    'MPLD-No-Trans-Skip': configs.get_3DMPLDNoTransSkip_config(),
    'MPLD-No-Skip': configs.get_3DMPLDNoSkip_config(),
    'MPLD-Lrn': configs.get_3DMPLDLrn_config(),
    'MPLD-Sin': configs.get_3DMPLDSin_config(),
    'MPLD-No-RelPosEmbed': configs.get_3DMPLDNoRelativePosEmbd_config(),
    'MPLD-Large': configs.get_3DMPLDLarge_config(),
    'MPLD-Small': configs.get_3DMPLDSmall_config(),
    'MPLD-Tiny': configs.get_3DMPLDTiny_config(),
}
